/*
 * theme-schema.js — clawd-on-desk 테마 포맷 검증기 (참조 사본)
 *
 * 출처: rullerzhou-afk/clawd-on-desk (https://github.com/rullerzhou-afk/clawd-on-desk)
 *       의 테마 로더(theme-loader) 소스에서 유래. 원저작권은 원저작자에게 있음.
 * 라이선스: GNU Affero General Public License v3.0 (AGPL-3.0) — 이 저장소의 LICENSE 참조.
 * 용도: ClawAd 테마 패키지(theme.json)를 앱 스키마로 사전 검증하는 개발 도구.
 * 변경: ClawAd 빌드 도구에서 사용하기 위한 참조 사본으로 격리(2026-07). 로직 변경 없음.
 */
"use strict";
